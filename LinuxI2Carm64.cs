...
{
    public class LinuxI2Carm64 : ILinuxI2C
    {
        public LinuxI2Carm64()
        {
            //Do nothing here.
        }
        ...
        public int Open(string device, int mode)
        {
        ...
        public void RegReadByte(int fd, int devaddr, int regaddr, ref int content)
        {
        ...
        public void RegWriteByte(int fd, Int16 addr, Int16 cmd, Int16 val)
        {
        ...
        public void RegReadByte(int fd, sbyte addr, sbyte cmd, ref sbyte val)
        {
        ...
        public void SRegReadShort(int fd, Int16 addr, Int16 cmd, ref Int16 val)
        {
            sbyte _addr = (sbyte)addr;
            sbyte _cmd = (sbyte)cmd;
        ...
        public void URegReadShort(int fd, Int16 addr, UInt16 cmd, ref UInt16 val)
        {
            sbyte _addr = (sbyte)addr;
            sbyte _cmd = (sbyte)cmd;
        ...
        public void RegRead24(int fd, sbyte addr, Int16 cmd, ref Int16 val)
        {
            sbyte _addr = (sbyte)addr;
            sbyte _cmd = (sbyte)cmd;
        ...
        public void RegWriteBytes(int fd, sbyte addr, Int16 cmd, Int16[] content)
        {
            sbyte _addr = (sbyte)addr;
